  ...
  return (
    <>
      <div className="container mx-auto  2xl:px-12">
        <div className="brand-section">
          ...
          <div ref={chineseSectionRef} className="chines-text mb-5 flex gap-12" style={{ width: '1220px', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="chines-headings">
              <h2 className="mb-8">{product?.textArea1 || "명륜진사갈비 40,000원 이용권"}</h2>
              {/* <p>[참고사항]</p>
        ...
        <div className="chines-headings" >
          <h2 className="mb-8">{product?.textArea2}</h2>
          {/* <p>[영업시간 및 방문 안내]</p>
          <p>※장찾기(클릭)</p>
          <p>※ 명륜진사갈비 홈페이지에서 확인 가능</p>
          <p>※ 모바일 이용권으로 제공되며 이용금액 내에서 자유롭게 이용 가능합니다.</p>
        ...
        <div className="chines-headings" >
          <h2 className="mb-8">{product?.textArea3 || "방문 및 예약안내"}</h2>
          {/* <p>[영업시간 및 방문 안내]</p>
          <p>※장찾기(클릭)</p>
          <p>※ 명륜진사갈비 홈페이지에서 확인 가능</p>
          <p>※ 모바일 이용권으로 제공되며 이용금액 내에서 자유롭게 이용 가능합니다.</p>
        ...
        <div  className="chines-headings" >
          <h2 className="mb-8">{product?.textArea4 || "방문 및 예약안내" }</h2>
          {/* <p>[영업시간 및 방문 안내]</p>
          <p>※장찾기(클릭)</p>
          <p>※ 명륜진사갈비 홈페이지에서 확인 가능</p>
          <p>※ 모바일 이용권으로 제공되며 이용금액 내에서 자유롭게 이용 가능합니다.</p>
